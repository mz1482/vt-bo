...
def approximate_point(suggestion, real_set, visited):
    """
...
class TargetSpace(object):
    ...
    """
    def __init__(self, target_func, pbounds, random_state=None, real_set=None):
        """
        Parameters
        ----------
        ...
        # Holds the discrete points within the input space for sampling
    ...
    def random_sample(self):
        ...
        data = approximate_point(data, self._real_set, [])
        return data.ravel()
